              ...
              <div class="card-body">
                <form method="post" action="{{ route('admin.teams.update', $team) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="nama" value="{{ old('nama', $team->nama) }}" id="nama">
                        </div>
                    </div>
                    <div class="form-group row border-bottom pb-4">
                        <label for="jabatan" class="col-sm-2 col-form-label">Jabatan</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="jabatan" value="{{ old('jabatan', $team->jabatan) }}" id="jabatan">
                        </div>
                    </div>
                    <div class="form-group row border-bottom pb-4">
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="bio" id="bio" cols="30" rows="6">{{ old('bio', $team->bio) }}</textarea>
                        </div>
                    </div>
